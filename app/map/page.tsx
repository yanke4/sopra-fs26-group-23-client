...
const ADJACENCY: Record<string, string[]> = {
  ...
  Italy: ["France", "Switzerland", "Austria", "Balkan"],
  Austria: [
    "Germany",
    "Switzerland",
    "Italy",
  ...
  Hungary: ["Austria", "Slovakia", "Ukraine", "Romania", "Balkan"],
  Romania: ["Ukraine", "Moldova", "Bulgaria", "Balkan", "Hungary"],
  Moldova: ["Ukraine", "Romania"],
  Bulgaria: ["Romania", "Greece", "Turkey", "Balkan"],
  Balkan: ["Italy", "Austria", "Hungary", "Romania", "Bulgaria", "Greece"],
